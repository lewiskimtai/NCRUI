...
const Userinsights = () => {
    return (
        <Box sx={{ textAlign: 'left', flexDirection: "column", backgroundColor: "white", padding: "10px", borderRadius: "20px", width: "500px" }}>
            <Typography style={{ fontSize: "15px", fontWeight: "bold" }}>User Insights</Typography>
            <Typography style={{ fontSize: "12px", color: "#717171", fontWeight: "lighter" }}>856 total users</Typography>
            <PieChart width={500} height={200}>
                <Pie
                    ...
                    dataKey="value"
                    paddingAngle={3}
                    label={CustomLabel} // Adding custom labels
                    labelLine={false} // Removing the label lines
                >
